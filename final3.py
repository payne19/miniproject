...
def insert():
    ...
    pytesseract.pytesseract.tesseract_cmd = r"C:\Users\Pavan\AppData\Local\Tesseract-OCR\tesseract.exe"
...
def m_sc():
    ...
    Label(screen,text="title",font=("times new roman",40,"bold"),bg="orange",fg="white",bd=10,relief=GROOVE).place(x=0,y=0,relwidth=1)
